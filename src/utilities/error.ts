export type ErrorResult<E extends Error> = { isError: true; error: E };
export type SuccessResult<R> = { isError?: false; value: R };
/**
 ...
 */
export type Throwable<R = unknown, E extends Error = Error> =
  | (R extends void ? void : SuccessResult<R>)
  | ErrorResult<E>;
...
export async function selectError<R, E>(
  ...
  try {
    ...
    return { value: res } as Throwable<R>;
  } catch (error) {
